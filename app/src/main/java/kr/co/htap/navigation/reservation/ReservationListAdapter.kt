...
class ReservationListAdapter(private val storeList: ArrayList<StoreEntity>) :
    RecyclerView.Adapter<ReservationListAdapter.MyViewHolder>() {
    inner class MyViewHolder(binding: ReservationListItemBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding =
            ReservationListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
